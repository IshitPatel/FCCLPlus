...
python3 main.py --model fccl  --device_id 0 --dataset fl_digits --structure homogeneity --csv_log&
python3 main.py --model fccl  --device_id 1 --dataset fl_office31 --structure homogeneity --csv_log&
